    ...
    <div className="mt-16 mx-2 md:mx-10 lg:mx-10" id="contact">
      ...
      <div className="flex flex-col w-full lg:flex-row">
        <div className="grid flex-grow min-h-fit card bg-base-200 rounded-box place-items-center">
          <form id="resetForm" action="https://formsubmit.co/sajed.sobuj@gmail.com" method="POST">
            <div className="hero">
              <div className="hero-content pt-0">
                <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl">
                  <div className="card-body">
                    ...
                    <div className="form-control">
                      <label className="label">
                        <span className="label-text font-sans font-bold">Message</span>
                      </label>
                      <textarea className="border-2 border-gray-100 p-1" name="message" id="msg" cols="2" rows="2" required></textarea>
                    </div>
                    <div className="form-control mt-2">
                      <button type="Submit" value="submit" className="btn bg-green-600 hover:bg-indigo-500 border-none">
                        SUBMIT
                      </button>
                    </div>
                  </div>
...
<div className="min-h-[880px] sm:min-h-[650px] md:min-h-[650px] lg:min-h-[650px]" id="contact">
      ...
      <div className="hero bg-base-100 border-0 lg:border border-green-500 rounded-md md:border-r-[6px] md:border-double md:border-r-green-500 lg:border-r-[6px] lg:border-double lg:border-green-500">
        <div className="hero-content pt-0">
          <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
            <div className="card-body">
              <h1 className="text-[16px] md:text-sm lg:text-2xl font-extrabold font-serif text-transparent bg-clip-text bg-gradient-to-t from-indigo-400 to-green-600">CONTACT ME</h1>
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-sans font-bold">Name</span>
                </label>
